...
We've created a seperate example package which can be found on the Unity Asset Store here:
...
This package demonstrates some of the features within Hydrogen, but not all.
